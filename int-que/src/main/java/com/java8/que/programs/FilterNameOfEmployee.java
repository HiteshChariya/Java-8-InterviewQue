...
public class FilterNameOfEmployee {
	...
	public static void main(String[] args) {
		...
		String filterName = "Hitesh";
		Optional<Employee> employeeNames = employees.stream().filter(e->e.getName().equalsIgnoreCase(filterName))
				.findAny();
		if(employeeNames.isPresent())
			System.out.println(employeeNames.get().getName());
